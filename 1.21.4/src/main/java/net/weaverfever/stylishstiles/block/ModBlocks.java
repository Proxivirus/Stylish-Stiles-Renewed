...
public class ModBlocks {
	...
	public static final RegistryKey<Block> PALE_OAK_STILE_KEY = RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(StylishStiles.MOD_ID, "pale_oak_stile"));
    private static final Block PALE_OAK_STILE = registerBlock("pale_oak_stile", new Stile(AbstractBlock.Settings.copy(Blocks.PALE_OAK_FENCE).registryKey(PALE_OAK_STILE_KEY)), PALE_OAK_STILE_KEY);
